...
import com.error404.laalkhata.dto.ApiErrorDTO;
...
public class ControllerAdvisor extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ApiErrorDTO> handleUserNotFoundException(UserDoesNotExistException e, final HttpServletRequest request) {
        ApiErrorDTO apiErrorDTO = new ApiErrorDTO(e.getStatus(), LocalDateTime.now(), e.getMessage(), request.getRequestURI());
        return new ResponseEntity<>(apiErrorDTO, e.getStatus());
    }
